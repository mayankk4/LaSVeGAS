...
text = '''Empressite is a mineral form of silver telluride, AgTe. It is a rare, grey, orthorhombic mineral with which can form compact masses, rarely as bipyrimidal crystals.'''
# Adding paragraph support
para = textwrap.wrap(text, width=40) # It seems that the width is the number of characters.
